...
describe 'Plugins(Minecraft PE) API', :type => :request do
  ...
  it 'Allows to start container' do
    ...
    @context.container = ApiDeploy::ContainerMinecraftPe.find(@context.container_id) rescue nil
  ...
  it 'Allows to enable plugin' do
    ...
    container = ApiDeploy::ContainerMinecraftPe.find(@context.container_id)
